...
model_path = './models/model_baseline_LSTM_V1_5_iterations_200_steps_each.model'
...
# export_summary_stat_path = './run_summary/Test_baseline_LSTM_V1_run_summary_t2.csv'
# export_summary_stat_path = './run_summary/Test_UDR_baseline_LSTM_V2_run_summary.csv'
export_summary_stat_path = './run_summary/Test_For_Data_Summary.csv'
...
action = dqn_agent.model.predict(obs)
print("action: ", action)
...
#             'Close', 'Volume', 'balance', 'max_net_worth',
#             'shares_held', 'cost_basis', 'total_sales_value'
#             ]

# df_new =  pd.DataFrame(obs[0].T , columns=columns)
