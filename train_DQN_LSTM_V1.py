...
export_summary_stat_path = './run_summary/base_line_LSTM_V1_run_summary.csv'
...
model_code = 'baseline_LSTM_V1_{0}_iterations_{1}_steps_each'.format(trials,trial_len)
